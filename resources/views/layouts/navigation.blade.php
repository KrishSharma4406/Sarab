    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20 w-full">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden sm:flex flex-1 overflow-x-auto whitespace-nowrap gap-2 px-4 scrollbar-hide">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link :href="route('products.main')" :active="request()->routeIs('products.create')">
                        {{ __('Create Product') }}
                    </x-nav-link>
